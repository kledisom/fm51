...
function dados(id) {
    var ocor = {
        ...
        'noTrama': document.getElementById('display21').value,
        'tramaFra': document.getElementById('display22').value,
        'defBom': document.getElementById('display23').value,
        'coniVazio': document.getElementById('display24').value,
        'quebraCala': document.getElementById('display25').value,
        'aliA': document.getElementById('display26').value,
        'aliB': document.getElementById('display27').value,
        'slubTram': document.getElementById('display28').value,
        'voltTrama': document.getElementById('display29').value,
        'outrosTram': document.getElementById('display210').value,
    }
